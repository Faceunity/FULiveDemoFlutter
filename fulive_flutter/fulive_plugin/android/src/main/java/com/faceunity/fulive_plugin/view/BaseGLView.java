...
import com.faceunity.fulive_plugin.utils.VideoRecordHelper;
...
public abstract class BaseGLView implements PlatformView {
    ...
    protected final OnGlRendererListener mOnGlRendererListener = new OnGlRendererListener() {
        ...
        public void onSurfaceCreated() {
            ...
            Log.d(this.getClass().getSimpleName(), "onSurfaceCreated: ");
        }

        @Override
        public void onSurfaceChanged(int width, int height) {
            Log.d(this.getClass().getSimpleName(), "onSurfaceChanged: ");
        }
        ...
        public void onSurfaceDestroy() {
            Log.d(this.getClass().getSimpleName(), "onSurfaceDestroy: ");
    ...
    protected volatile long recordTime = 0;
    ...
    protected void onRecordFinish(File file) {
        if (recordTime < 1100) {
            mGLTextureView.post(() -> ToastHelper.showNormalToast(mContext, "视频太短啦！"));
        } else {
    ...
    private final OnPhotoRecordingListener mOnPhotoRecordingListener = new OnPhotoRecordingListener() {
        ...
        public void onRecordSuccess(Bitmap bitmap) {
            new Thread(() -> {
                ...
                if (path == null) return;
                mGLTextureView.post(() -> ToastHelper.showNormalToast(mContext, "图片已保存到相册"));
            }).start();
        }
    };
