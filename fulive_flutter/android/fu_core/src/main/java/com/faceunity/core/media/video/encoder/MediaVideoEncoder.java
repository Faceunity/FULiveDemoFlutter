...
public class MediaVideoEncoder extends MediaEncoder {
    ...
    String TAG = "Video_MediaVideoEncoder";
    ...
    public boolean frameAvailableSoon(int texId, float[] texMatrix, float[] mvpMatrix) {
        ...
        if (result = super.frameAvailableSoon()) {
            mRenderHandler.draw(mFboTex[0], texMatrix, GlUtil.IDENTITY_MATRIX);
        }
        return result;
    }
...
//        	MediaCodecInfo.CodecCapabilities.COLOR_QCOM_FormatYUV420SemiPlanar,
    ...
    private final boolean isRecognizedViewoFormat(final int colorFormat) {
