...
import 'package:fulivedemo_flutter/business/beauty/beauty_image_render.dart';
import 'package:fulivedemo_flutter/business/beauty/beauty_video_render.dart';
import 'package:fulivedemo_flutter/business/sticker/sticker_image_render.dart';
import 'package:fulivedemo_flutter/business/sticker/sticker_video_render.dart';
...
class MediaPickerState extends State<MediaPicker> {
  ...
  void _analysisCallBack(MethodCall call) {
    if(call.method == "photoSelected") {
      ...
      if (result) {
        Navigator.of(context).push(FadePageRoute(builder: (context) {
