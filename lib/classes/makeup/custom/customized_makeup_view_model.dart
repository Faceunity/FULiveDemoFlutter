...
import 'package:fulivedemo_flutter/classes/makeup/custom/customized_makeup_model.dart';
...
class CustomizedMakeupViewModel extends ChangeNotifier {
  ...
  Future<void> initizlize() async {
    // Flutter 中加载本地文件要求异步
    String jsonString = await rootBundle.loadString(CommonUtil.fileNamed("jsons/makeup/custom/customized_makeups.json"));
