...
class BeautyVideoRender extends StatefulWidget {
  const BeautyVideoRender({super.key});

  @override
  State<StatefulWidget> createState() {
    return BeautyVideoState();
  }
}

class BeautyVideoState extends State<BeautyVideoRender> {
