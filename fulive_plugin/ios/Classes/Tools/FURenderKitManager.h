...
@property (nonatomic, strong, nullable) FUGLDisplayView *cameraRenderView;

@property (nonatomic, strong, nullable) FUGLDisplayView *imageRenderView;

@property (nonatomic, strong, nullable) FUGLDisplayView *videoRenderView;
