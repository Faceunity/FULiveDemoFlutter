...
import com.faceunity.fuliveplugin.fulive_plugin.utils.device.DeviceScoreUtils;
...
public class FuDeviceUtils {
    ...
    public static HashMap<String, ArrayList<String>> getBlackListMap() {
        String blackList = FileUtils.loadStringFromLocal(FUApplication.getApplication(), FaceunityConfig.BLACK_LIST);
        Gson gson = new Gson();
    ...
    public static void saveCacheDeviceLevel(int level) {
        SharedPreferences sp = FUApplication.getApplication().getSharedPreferences(DEVICE_LEVEL, MODE_PRIVATE);
